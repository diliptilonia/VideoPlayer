...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func redirectToHome() {
        ...
        let home = stroyBoard.instantiateViewController(withIdentifier: "ViewController") as! ViewController
        let sideMenu = stroyBoard.instantiateViewController(withIdentifier: "SideMenuVC") as! SideMenuVC
        let navigationController = UINavigationController.init(rootViewController: home)
        
        let sideMenuController = LGSideMenuController(rootViewController: home, leftViewController: sideMenu, rightViewController: nil)
        
        sideMenuController.delegate = self
        sideMenuController.leftViewWidth = 217
...
extension AppDelegate: LGSideMenuDelegate {
